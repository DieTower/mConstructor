...
class Nav {
    ...
    attachmentEvent() {
        ...
        this.insert.addEventListener("click",this.toInsert.bind(this));
        ...
        this.script.addEventListener("click",this.toScript.bind(this));
        ...
        this.expense.addEventListener("click",this.toExpense.bind(this));
        ...
        this.settings.addEventListener("click",this.toSettings.bind(this));
