...
class Index {
    ...
    putData() {
        if(this.check()) {
            var url = "./php/insertObjects.php?name=" + this.name.value + "&origin=" + this.origin.value + "&amount=" + this.amount.value + "&price=" + this.price.value + "&description=" + this.description.value;
            this.ajax(url);
        } else {
    ...
    check() {
        ...
        if(this.name.value == "" || this.origin.value == "" || this.amount.value == "" || this.price.value == "") {
            trueOrFalse = false;
        }
